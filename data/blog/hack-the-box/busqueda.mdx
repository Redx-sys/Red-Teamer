...
draft: false
summary: 'Busqueda es una maquina sencilla en la cual debemos explotar la vulnerabilidad de Searchor 2.4.0 para una vez dentro ingeniarnosla y escalar privilegios'
