...
Indicates the sum of a sequence of terms. For example:
```
Σ_{i=1}^{n} a_i
```

This represents the sum of the terms a₁, a₂, ..., a_n. The sum is used in many mathematical formulas, including the calculation of means, variances, and series.
The **Σ** (pronounced “sigma”) means **“to add many terms”** according to a rule.

**General example:**
![li](/static/images/ai/mathematics_refresher_for_ai_part_1/5.png)

It reads: “**add the a_i from i=1 to i=n”**.

That is: a1 + a2 + a3 + ⋯ + an

Simple example
![li](/static/images/ai/mathematics_refresher_for_ai_part_1/6.png)

Example with a ruler
![li](/static/images/ai/mathematics_refresher_for_ai_part_1/7.png)

Example 3 (squares)
![li](/static/images/ai/mathematics_refresher_for_ai_part_1/8.png)

## Exercises
D) ![li](/static/images/ai/mathematics_refresher_for_ai_part_1/9.png)
E) ![li](/static/images/ai/mathematics_refresher_for_ai_part_1/10.png)
F) ![li](/static/images/ai/mathematics_refresher_for_ai_part_1/11.png)
G) ![li](/static/images/ai/mathematics_refresher_for_ai_part_1/12.png)
...
D) 1+2+3+4+5+6=21
E) 3(1)+3(2)+3(3)+3(4)=3+6+9+12=30
F) (1+1)+(2+1)+(3+1)+(4+1)+(5+1)=2+3+4+5+6=20
G) 2^1 + 2^2 + 2^3 + 2^4 = 2 + 4 + 8 + 16 = 30