---
title: Brecha en la Nube
date: '2024-10-08'
lastmod: '2024-10-08'
tags: ['AWS', 'Pwned Labs', 'Cloudtrail', 'S3', 'IAM', 'Blue-Team']
draft: true
summary: 'Muestra el uso de registros de AWS CloudTrail para detectar actividad maliciosa, así como la enumeración de S3. '
...
![image](/static/images/pwned_labs/breach_in_the_cloud/1.png)
...
![image](/static/images/pwned_labs/breach_in_the_cloud/2.png)
...
![image](/static/images/pwned_labs/breach_in_the_cloud/3.png)
...
![image](/static/images/pwned_labs/breach_in_the_cloud/4.png)
...
![image](/static/images/pwned_labs/breach_in_the_cloud/5.png)
...
![image](/static/images/pwned_labs/breach_in_the_cloud/6.png)
...
![image](/static/images/pwned_labs/breach_in_the_cloud/7.png)
...
![image](/static/images/pwned_labs/breach_in_the_cloud/8.png)

```
grep errorMessage 107513503799_CloudTrail_us-east-1_20230826T2050Z_iUtQqYPskB20yZqT.json
```

![image](/static/images/pwned_labs/breach_in_the_cloud/9.png)
...
![image](/static/images/pwned_labs/breach_in_the_cloud/10.png)
...
![image](/static/images/pwned_labs/breach_in_the_cloud/11.png)
...
![image](/static/images/pwned_labs/breach_in_the_cloud/12.png)
...
![image](/static/images/pwned_labs/breach_in_the_cloud/13.png)

![image](/static/images/pwned_labs/breach_in_the_cloud/14.png)

¡Se descargó el archivo emergence.txt!

![image](/static/images/pwned_labs/breach_in_the_cloud/15.png)
...
{
    "Credentials": {
        "AccessKeyId": "ASIARSCCN4A3RCYIDY2Y",
        "SecretAccessKey": "C2kcfmWYkMFPhKkxyyrWo5x75ceX/HWitSczaEU8",
        "SessionToken": "",
...
![image](/static/images/pwned_labs/breach_in_the_cloud/16.png)
